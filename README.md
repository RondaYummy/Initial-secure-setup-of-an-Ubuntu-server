...
- У більшості систем це налаштовано за замовчуванням. Наприклад:
  - У Debian/Ubuntu існує група `sudo`.
...
- У RedHat/AlmaLinux для цього використовується група `wheel`.

#### Кроки

1. Створити власну групу для sudo-користувачів:

```bash
sudo groupadd sudousers
```

2. Додати потрібних користувачів до групи:
...
3. Зробити резервну копію конфігураційного файлу sudo:

```bash
sudo cp --archive /etc/sudoers /etc/sudoers-COPY-$(date +"%Y%m%d%H%M%S")
```

4. Відредагувати sudoers:
...
1. Створити групу для користувачів, які можуть використовувати su:
...
3. Обмежити виконання `/bin/su` лише для цієї групи:
